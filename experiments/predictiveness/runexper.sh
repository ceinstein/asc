...
do ./asc -a $line/500 ../ubasicexper/experiments/executables/$rsaname &> ../ubasicexper/experiments/predictiveness/$line.txt;
...
done < ../ubasicexper/experiments/predictiveness/rsa_basic_loop_pcs.txt;
