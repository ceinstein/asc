...
create(){
	...
	do
		...
		do
		    ...
		    then
			./asc -a $line/$window ../ubasicexper/experiments/predictiveness/$filetype/$exec/nets/$executable\_$line\_$window.net ../ubasicexper/experiments/executables/$executable &> ../ubasicexper/experiments/predictiveness/$executable\_$window/$line.txt;
